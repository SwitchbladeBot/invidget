...
- **When using a server ID**, make sure to enable the Server Widget by going to <kbd><kbd>Server Settings</kbd> ⇒ <kbd>Widget</kbd></kbd> and then checking <kbd>Enable Server Widget</kbd>. Make sure to select an <kbd>Invite Channel</kbd> too.
